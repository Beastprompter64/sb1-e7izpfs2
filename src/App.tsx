      ...
      for (let a = 0; a < particlesArray.length; a++) {
        for (let b = a; b < particlesArray.length; b++) {
          ...
          if (distance < config.maxDistance * config.maxDistance) {
            opacityValue =
              1 - distance / (config.maxDistance * config.maxDistance);
...
function App() {
  ...
  return (
    <>
      <SEO
        title="Digital Factory & Développement IT | Accélérez vos Projets"
        description="Déployez votre équipe de développement offshore en 10 jours. Experts en développement agile, solutions IT innovantes et transformation digitale à Madagascar."
        name="Digital Factory"
        type="website"
        keywords="développement offshore, squad agile, développement IT, Madagascar, transformation digitale, time to market, innovation technologique"
      />
      <GlobalStyles />
      <Header />
          ...
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-gray-900 fade-in">
              <span className="text-gradient">
                Divisez par 2 votre Time-to-Market.
              </span>
            ...
            <p className="mt-6 max-w-2xl mx-auto text-lg md:text-xl text-gray-600 fade-in fade-in-delay-1">
              Déployez votre Squad Agile offshore en 10 jours. Nos équipes à
              Madagascar, augmentées par l'IA, transforment vos idées en
              produits plus vite que jamais.
            </p>

            <div className="mt-10 flex justify-center items-center gap-4 flex-wrap fade-in fade-in-delay-2">
              <a
                href="#contact"
                className="hero-cta-primary inline-block rounded-md px-6 py-3 text-base font-semibold text-white shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              >
                <span>Lancer mon projet →</span>
              </a>
              <a
                href="#trial"
                className="inline-block rounded-md border border-gray-300 px-6 py-3 text-base font-semibold text-gray-700 hover:bg-gray-100 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-transform transform hover:scale-105"
              >
          ...
          <div className="mt-20 lg:mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 text-left fade-in fade-in-delay-3">
            <div className="pillar-card bg-slate-50/80 backdrop-blur-sm p-6 rounded-xl border border-gray-200 shadow-sm">
              ...
              <p className="mt-2 text-gray-600">
                Une équipe opérationnelle en 10 jours et des sprints de 2
                semaines pour une livraison accélérée et une adaptation
                continue.
              </p>
            </div>
            ...
            <div className="pillar-card bg-slate-50/80 backdrop-blur-sm p-6 rounded-xl border border-gray-200 shadow-sm">
              <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-teal-50 mb-4">
                ...
                >
                  ...
                  <path
                    d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.75A.75.75 0 013 4.5h.75m0 0H21m-9 12.75h5.25m-5.25 0h-5.25m5.25 0V15m0 3.75V15m0 0H9m5.25 0h5.25M9 15h5.25"
              ...
              <p className="mt-2 text-gray-600">
                Accédez à des talents seniorisés avec un TJM ultra-compétitif.
                Un modèle simple, prévisible, sans frais cachés.
              </p>
            </div>
            ...
            <div className="pillar-card bg-slate-50/80 backdrop-blur-sm p-6 rounded-xl border border-gray-200 shadow-sm">
              <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-teal-50 mb-4">
                ...
                >
                  ...
                  <path
                    d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.898 20.562L16.25 22.5l-.648-1.938a3.375 3.375 0 00-2.684-2.684l-1.938-.648 1.938-.648a3.375 3.375 0 002.684-2.684l.648-1.938.648 1.938a3.375 3.375 0 002.684 2.684l1.938.648-1.938.648a3.375 3.375 0 00-2.684 2.684z"
              ...
              <p className="mt-2 text-gray-600">
                Chaque squad est équipée d'outils IA (Copilot, tests auto) pour
                booster la productivité, la qualité et la documentation.
              </p>
            </div>
          </div>
        </div>
